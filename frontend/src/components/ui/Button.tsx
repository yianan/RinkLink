...
const variants: Record<ButtonVariant, string> = {
  ...
  outline:
    'border border-slate-200/80 bg-white/80 text-slate-900 shadow-sm backdrop-blur-[1px] hover:border-cyan-400/50 hover:bg-slate-50 hover:text-slate-950 hover:ring-1 hover:ring-cyan-400/15 disabled:border-slate-200/70 disabled:bg-slate-50/60 disabled:text-slate-500 dark:border-slate-700/80 dark:bg-slate-950/35 dark:text-slate-100 dark:hover:border-cyan-400/40 dark:hover:bg-slate-900/45 dark:hover:ring-cyan-400/15 dark:disabled:border-slate-700/50 dark:disabled:bg-slate-950/20 dark:disabled:text-slate-500',
  ghost:
    'text-slate-800 hover:bg-slate-100/80 disabled:text-slate-400 dark:text-slate-200 dark:hover:bg-slate-800/55 dark:disabled:text-slate-500',
  destructive:
