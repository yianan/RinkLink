  ...
  return (
    <DialogPrimitive.Root open={mobileNavOpen} onOpenChange={setMobileNavOpen}>
      <div className="min-h-full">
        <header
          ref={headerRef}
          className="fixed inset-x-0 top-0 z-40 border-b border-slate-200/70 bg-gradient-to-r from-white via-cyan-50 to-violet-50 dark:border-white/10 dark:from-slate-950 dark:via-slate-950 dark:to-slate-950"
        >
